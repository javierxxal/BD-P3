...
-- object: public.PRUEBA_INDIVIDUAL | type: TABLE --
-- DROP TABLE IF EXISTS public.PRUEBA_INDIVIDUAL CASCADE;
...
-- ALTER TABLE public.PRUEBA_INDIVIDUAL DROP CONSTRAINT IF EXISTS FASE_fk CASCADE;
...
-- object: PRUEBA_INDIVIDUAL_fk | type: CONSTRAINT --
-- ALTER TABLE public.candidato_realiza_prueba DROP CONSTRAINT IF EXISTS PRUEBA_INDIVIDUAL_fk CASCADE;
